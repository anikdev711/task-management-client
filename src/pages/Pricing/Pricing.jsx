...
const Pricing = () => {
    return (
        <div>
            ...
            <h1 className="text-center font-bold text-2xl mt-10">Pricing</h1>
            <br />

            <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-5 max-w-2xl mx-auto mt-10 mb-10">


                <div>
                    <div
                        className="relative flex flex-col bg-clip-border rounded-xl bg-gradient-to-tr from-gray-900 to-gray-800 text-white shadow-gray-900/20 shadow-md p-8">
                        <div
